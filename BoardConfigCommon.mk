...
# Security
#
# The stock firmware used as the runtime/vendor baseline reports this SPL in
# bootloader. Keep AVB rollback indexes at or above that value; otherwise the
# bootloader can reject freshly flashed inactive slots before Android starts.
XIAOMI_SM8750_SECURITY_PATCH := 2026-02-01
XIAOMI_SM8750_SECURITY_PATCH_TIMESTAMP := 1769904000

BOOT_SECURITY_PATCH := $(XIAOMI_SM8750_SECURITY_PATCH)
VENDOR_SECURITY_PATCH := $(XIAOMI_SM8750_SECURITY_PATCH)
...
BOARD_AVB_BOOT_ROLLBACK_INDEX := $(XIAOMI_SM8750_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION := 3

BOARD_AVB_RECOVERY_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem
BOARD_AVB_RECOVERY_ALGORITHM := SHA256_RSA4096
BOARD_AVB_RECOVERY_ROLLBACK_INDEX := $(XIAOMI_SM8750_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_RECOVERY_ROLLBACK_INDEX_LOCATION := 1

BOARD_AVB_VBMETA_SYSTEM := system system_dlkm system_ext product
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(XIAOMI_SM8750_SECURITY_PATCH_TIMESTAMP)
